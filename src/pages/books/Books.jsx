      ...
      <div className="flex flex-col md:flex-row justify-center items-center gap-5 mb-5">
        ...
        <div>
          <select
            ...
            name="sort"
            id="sort"
            className="border border-green-600 p-4 rounded-md"
          >
        ...
        <form onSubmit={handleSearch}>
          <div className="flex p-1 overflow-hidden border border-green-600 rounded-lg focus-within:ring focus-within:ring-opacity-40 focus-within:border-blue-400 focus-within:ring-blue-300">
            <input
            ...
            <button className="px-1 md:px-4 py-3 text-sm font-medium tracking-wider text-gray-100 uppercase transition-colors duration-300 transform bg-green-600 rounded-md hover:bg-green-500 focus:bg-gray-600 focus:outline-none">
              Search
            </button>
          </div>
        </form>
